...
Partial Class RASTREO_Administracion_admin_equipogps
    ...
    Private Function Guardar_Datos() As Boolean
        ...
        Try
            ...
            If ddlTipoDeEquipoGPS.Items.Count < 1 Then
                Session.Add("msjerror", "Aún no ha ingresado tipos de equipo GPS, HAGALO!. Gracias")
                Throw New Exception("msjerror")
            End If
            If ddlSIMs.Items.Count < 1 Then
                Session.Add("msjerror", "Aún no ha ingresado SIM cards, HAGALO!. Gracias")
                Throw New Exception("msjerror")
            End If
            With tblEQUIPOGPS
                ...
                Else
                    ...
                    If .Query.Load() Then
                        If .RowCount > 0 Then
                            ...
                            tblTE.Query.Load()
                            Session.Add("msjerror", "Ya existe un equipo GPS con ese ID y tipo de equipo. Info: ID=" + .Id_equipo_gps + " Tipo Equipo=" + tblTE.s_Tipo_equipo)
                            Throw New Exception("msjerror")
                        End If
                    End If
                    .FlushData()
    ...
    Protected Sub btnGUARDAR_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGUARDAR.Click
        If Guardar_Datos() Then
            txtEQUIPOGPS_id_equipo_gps.Text = String.Empty
            txtEQUIPOGPS_nro_serie.Text = String.Empty
        End If
    End Sub
    ...
    Protected Sub imgbtn_SIMsave_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtn_SIMsave.Click
        ...
        With tblSIM
            If ViewState("EditSIM") Then
                ...
                If Not .Query.Load() Then
                    Session.Add("msjerror", "NO SE QUE PASO MEN - SIMS")
                    Exit Sub
                End If
                .Fech_upd = Now
                .User_upd = mi_usuario.idUsuario
            Else
                ...
                If .Query.Load Then
                    If .RowCount > 0 Then
                        Session.Add("msjerror", "SIM con ese numero ya existe.")
                        Exit Sub
                    End If
                End If
                .AddNew()
            ...
            If ViewState("EditSIM") Then
                Session.Add("msjerror", "SIM editado con exito.")
            Else
                Session.Add("msjerror", "SIM registrado.")
            End If
            BindSIM(.s_Sim_nro)
            panel_TipoDeEquipoGPS_select.Visible = True
    ...
    Protected Sub btnNuevo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNuevo.Click
        Response.Redirect("iadmingps_equipogps.aspx", False)
    End Sub
End Class

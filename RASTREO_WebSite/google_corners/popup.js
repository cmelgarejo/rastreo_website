...
CORNERS = {
    ...
    /* top images*/
    TL: { src: 'topl.png', sizing: 'scale' },
    TM: { src: 'topm.png', sizing: 'crop' },
    TR: { src: 'topr.png', sizing: 'scale' },

    /* middle images */
    ML: { src: 'midl.png', sizing: 'crop' },
    MR: { src: 'midr.png', sizing: 'crop' },

    /* bottom images */
    BL: { src: 'botl.png', sizing: 'scale' },
    BM: { src: 'botm.png', sizing: 'crop' },
    BR: { src: 'botr.png', sizing: 'scale' }
}

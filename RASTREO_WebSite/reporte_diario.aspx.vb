...
Partial Class Historico
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Request.QueryString.Keys.Count < 1 Then
                Response.Redirect("./Login.aspx?to=" + Now.ToString(), False)
                Return
            End If
            'Session.Timeout = 60
            ...
            With tblVehiculoAux
                ...
                If .Query.Load() Then
                    ...
                    With tblClienteAux
                        ...
                        If .Query.Load() Then
                            If .RowCount > 0 Then
                                If (.s_Ra_horaenvio <> "") Then
                                    horaEnvioRpt = .Ra_horaenvio
                                Else
                                    horaEnvioRpt = DateTime.Now
                                End If
            ...
            txtFECHAINICIO.Value = Convert.ToDateTime(fechaInicioRpt).ToString("dd/MM/yyyy HH:mm:ss")
            txtFECHAFIN.Value = Convert.ToDateTime(fechaFinRpt).ToString("dd/MM/yyyy HH:mm:ss")             'Now.ToString("dd/MM/yyyy HH:mm:ss")
            setSQLCMD()
            Reload_Data()
            'End If

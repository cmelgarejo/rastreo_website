...
namespace MyGeneration.dOOdads
{
	...
	{		
		...
		/// </remarks>
		public string StringFormat = "dd/MM/yyyy";
		...
		{
			return this.LoadFromSqlNoExec(sp, null, CommandType.StoredProcedure, 60);
		}
		...
		{
			return this.LoadFromSqlNoExec(sp, Parameters, CommandType.StoredProcedure, 60);
		}
		...
		{
			return this.LoadFromSqlScalar(sp, null, CommandType.StoredProcedure, 120);
		}
		...
		{
			return this.LoadFromSqlScalar(sp, Parameters, CommandType.StoredProcedure, 120);
		}

...
'  Clase que implementa una business entity para la tabla rastreo_marca_vehiculo.
...
namespace RASTREOmw
{
	public abstract class _rastreo_marca_vehiculo : PostgreSqlEntity
	{
		public _rastreo_marca_vehiculo()
		{
			this.QuerySource = "rastreo_marca_vehiculo";
			this.MappingName = "rastreo_marca_vehiculo";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql(this.SchemaStoredProcedure + "rastreo_marca_vehiculo_load_all", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int Idrastreo_marca_vehiculo)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.Idrastreo_marca_vehiculo, Idrastreo_marca_vehiculo);

		
			return base.LoadFromSql(this.SchemaStoredProcedure + "rastreo_marca_vehiculo_load_by_primarykey", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static NpgsqlParameter Idrastreo_marca_vehiculo
			{
				get
				{
					return new NpgsqlParameter("Idrastreo_marca_vehiculo", NpgsqlTypes.NpgsqlDbType.Integer, 0);
				}
			}
		...
		{  
            public const string Idrastreo_marca_vehiculo = "idrastreo_marca_vehiculo";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[Idrastreo_marca_vehiculo] = _rastreo_marca_vehiculo.PropertyNames.Idrastreo_marca_vehiculo;
					ht[Marca] = _rastreo_marca_vehiculo.PropertyNames.Marca;
					ht[User_ins] = _rastreo_marca_vehiculo.PropertyNames.User_ins;
					ht[Fech_ins] = _rastreo_marca_vehiculo.PropertyNames.Fech_ins;
					ht[User_upd] = _rastreo_marca_vehiculo.PropertyNames.User_upd;
					ht[Fech_upd] = _rastreo_marca_vehiculo.PropertyNames.Fech_upd;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[Idrastreo_marca_vehiculo] = _rastreo_marca_vehiculo.ColumnNames.Idrastreo_marca_vehiculo;
					ht[Marca] = _rastreo_marca_vehiculo.ColumnNames.Marca;
					ht[User_ins] = _rastreo_marca_vehiculo.ColumnNames.User_ins;
					ht[Fech_ins] = _rastreo_marca_vehiculo.ColumnNames.Fech_ins;
					ht[User_upd] = _rastreo_marca_vehiculo.ColumnNames.User_upd;
					ht[Fech_upd] = _rastreo_marca_vehiculo.ColumnNames.Fech_upd;
		...
		{  
            public const string Idrastreo_marca_vehiculo = "s_Idrastreo_marca_vehiculo";
		...
		public virtual int Idrastreo_marca_vehiculo
	    {
			get
	        {
				return base.Getint(ColumnNames.Idrastreo_marca_vehiculo);
			}
			set
	        {
				base.Setint(ColumnNames.Idrastreo_marca_vehiculo, value);
			}
		}
		...
		public virtual string s_Idrastreo_marca_vehiculo
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Idrastreo_marca_vehiculo) ? string.Empty : base.GetintAsString(ColumnNames.Idrastreo_marca_vehiculo);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.Idrastreo_marca_vehiculo);
				else
					this.Idrastreo_marca_vehiculo = base.SetintAsString(ColumnNames.Idrastreo_marca_vehiculo, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter Idrastreo_marca_vehiculo
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.Idrastreo_marca_vehiculo, Parameters.Idrastreo_marca_vehiculo);
			...
			public WhereParameter Idrastreo_marca_vehiculo
		    {
				get
		        {
					if(_Idrastreo_marca_vehiculo_W == null)
	        	    {
						_Idrastreo_marca_vehiculo_W = TearOff.Idrastreo_marca_vehiculo;
					}
					return _Idrastreo_marca_vehiculo_W;
				}
			}
			...
			private WhereParameter _Idrastreo_marca_vehiculo_W = null;
			...
			{
				_Idrastreo_marca_vehiculo_W = null;
				_Marca_W = null;
				_User_ins_W = null;
				_Fech_ins_W = null;
				_User_upd_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter Idrastreo_marca_vehiculo
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.Idrastreo_marca_vehiculo, Parameters.Idrastreo_marca_vehiculo);
			...
			private AggregateParameter _Idrastreo_marca_vehiculo_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_marca_vehiculo_insert";
	
			CreateParameters(cmd);
			
			NpgsqlParameter p;
			p = cmd.Parameters[Parameters.Idrastreo_marca_vehiculo.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			NpgsqlCommand cmd = new NpgsqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_marca_vehiculo_update";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			NpgsqlCommand cmd = new NpgsqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_marca_vehiculo_delete";
	
			NpgsqlParameter p;
			p = cmd.Parameters.Add(Parameters.Idrastreo_marca_vehiculo);
			p.SourceColumn = ColumnNames.Idrastreo_marca_vehiculo;

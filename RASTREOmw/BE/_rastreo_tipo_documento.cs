...
'  Clase que implementa una business entity para la tabla rastreo_tipo_documento.
...
namespace RASTREOmw
{
	public abstract class _rastreo_tipo_documento : PostgreSqlEntity
	{
		public _rastreo_tipo_documento()
		{
			this.QuerySource = "rastreo_tipo_documento";
			this.MappingName = "rastreo_tipo_documento";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql(this.SchemaStoredProcedure + "rastreo_tipo_documento_load_all", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int Idrastreo_tipo_documento)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.Idrastreo_tipo_documento, Idrastreo_tipo_documento);

		
			return base.LoadFromSql(this.SchemaStoredProcedure + "rastreo_tipo_documento_load_by_primarykey", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static NpgsqlParameter Idrastreo_tipo_documento
			{
				get
				{
					return new NpgsqlParameter("Idrastreo_tipo_documento", NpgsqlTypes.NpgsqlDbType.Integer, 0);
				}
			}
			...
			public static NpgsqlParameter Descripcion
			{
				get
				{
					return new NpgsqlParameter("Descripcion", NpgsqlTypes.NpgsqlDbType.Varchar, 512);
				}
			}
		...
		{  
            public const string Idrastreo_tipo_documento = "idrastreo_tipo_documento";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[Idrastreo_tipo_documento] = _rastreo_tipo_documento.PropertyNames.Idrastreo_tipo_documento;
					ht[Descripcion] = _rastreo_tipo_documento.PropertyNames.Descripcion;
					ht[User_ins] = _rastreo_tipo_documento.PropertyNames.User_ins;
					ht[Fech_ins] = _rastreo_tipo_documento.PropertyNames.Fech_ins;
					ht[User_upd] = _rastreo_tipo_documento.PropertyNames.User_upd;
					ht[Fech_upd] = _rastreo_tipo_documento.PropertyNames.Fech_upd;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[Idrastreo_tipo_documento] = _rastreo_tipo_documento.ColumnNames.Idrastreo_tipo_documento;
					ht[Descripcion] = _rastreo_tipo_documento.ColumnNames.Descripcion;
					ht[User_ins] = _rastreo_tipo_documento.ColumnNames.User_ins;
					ht[Fech_ins] = _rastreo_tipo_documento.ColumnNames.Fech_ins;
					ht[User_upd] = _rastreo_tipo_documento.ColumnNames.User_upd;
					ht[Fech_upd] = _rastreo_tipo_documento.ColumnNames.Fech_upd;
		...
		{  
            public const string Idrastreo_tipo_documento = "s_Idrastreo_tipo_documento";
		...
		public virtual int Idrastreo_tipo_documento
	    {
			get
	        {
				return base.Getint(ColumnNames.Idrastreo_tipo_documento);
			}
			set
	        {
				base.Setint(ColumnNames.Idrastreo_tipo_documento, value);
			}
		}
		...
		public virtual string s_Idrastreo_tipo_documento
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Idrastreo_tipo_documento) ? string.Empty : base.GetintAsString(ColumnNames.Idrastreo_tipo_documento);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.Idrastreo_tipo_documento);
				else
					this.Idrastreo_tipo_documento = base.SetintAsString(ColumnNames.Idrastreo_tipo_documento, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter Idrastreo_tipo_documento
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.Idrastreo_tipo_documento, Parameters.Idrastreo_tipo_documento);
			...
			public WhereParameter Idrastreo_tipo_documento
		    {
				get
		        {
					if(_Idrastreo_tipo_documento_W == null)
	        	    {
						_Idrastreo_tipo_documento_W = TearOff.Idrastreo_tipo_documento;
					}
					return _Idrastreo_tipo_documento_W;
				}
			}
			...
			private WhereParameter _Idrastreo_tipo_documento_W = null;
			...
			{
				_Idrastreo_tipo_documento_W = null;
				_Descripcion_W = null;
				_User_ins_W = null;
				_Fech_ins_W = null;
				_User_upd_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter Idrastreo_tipo_documento
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.Idrastreo_tipo_documento, Parameters.Idrastreo_tipo_documento);
			...
			private AggregateParameter _Idrastreo_tipo_documento_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_tipo_documento_insert";
	
			CreateParameters(cmd);
			
			NpgsqlParameter p;
			p = cmd.Parameters[Parameters.Idrastreo_tipo_documento.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			NpgsqlCommand cmd = new NpgsqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_tipo_documento_update";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			NpgsqlCommand cmd = new NpgsqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_tipo_documento_delete";
	
			NpgsqlParameter p;
			p = cmd.Parameters.Add(Parameters.Idrastreo_tipo_documento);
			p.SourceColumn = ColumnNames.Idrastreo_tipo_documento;

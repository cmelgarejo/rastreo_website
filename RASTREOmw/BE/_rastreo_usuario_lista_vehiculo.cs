...
'  Clase que implementa una business entity para la tabla rastreo_usuario_lista_vehiculo.
...
namespace RASTREOmw
{
	public abstract class _rastreo_usuario_lista_vehiculo : PostgreSqlEntity
	{
		public _rastreo_usuario_lista_vehiculo()
		{
			this.QuerySource = "rastreo_usuario_lista_vehiculo";
			this.MappingName = "rastreo_usuario_lista_vehiculo";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql(this.SchemaStoredProcedure + "rastreo_usuario_lista_vehiculo_load_all", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int Id_listavehiculos, int Id_usuarios)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.Id_listavehiculos, Id_listavehiculos);

parameters.Add(Parameters.Id_usuarios, Id_usuarios);

		
			return base.LoadFromSql(this.SchemaStoredProcedure + "rastreo_usuario_lista_vehiculo_load_by_primarykey", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static NpgsqlParameter Id_listavehiculos
			{
				get
				{
					return new NpgsqlParameter("Id_listavehiculos", NpgsqlTypes.NpgsqlDbType.Integer, 0);
				}
			}
		...
		{  
            public const string Id_listavehiculos = "id_listavehiculos";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[Id_listavehiculos] = _rastreo_usuario_lista_vehiculo.PropertyNames.Id_listavehiculos;
					ht[Id_usuarios] = _rastreo_usuario_lista_vehiculo.PropertyNames.Id_usuarios;
					ht[Id_cliente] = _rastreo_usuario_lista_vehiculo.PropertyNames.Id_cliente;
					ht[Id_vehiculo] = _rastreo_usuario_lista_vehiculo.PropertyNames.Id_vehiculo;
					ht[Visible] = _rastreo_usuario_lista_vehiculo.PropertyNames.Visible;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[Id_listavehiculos] = _rastreo_usuario_lista_vehiculo.ColumnNames.Id_listavehiculos;
					ht[Id_usuarios] = _rastreo_usuario_lista_vehiculo.ColumnNames.Id_usuarios;
					ht[Id_cliente] = _rastreo_usuario_lista_vehiculo.ColumnNames.Id_cliente;
					ht[Id_vehiculo] = _rastreo_usuario_lista_vehiculo.ColumnNames.Id_vehiculo;
					ht[Visible] = _rastreo_usuario_lista_vehiculo.ColumnNames.Visible;
		...
		{  
            public const string Id_listavehiculos = "s_Id_listavehiculos";
		...
		public virtual int Id_listavehiculos
	    {
			get
	        {
				return base.Getint(ColumnNames.Id_listavehiculos);
			}
			set
	        {
				base.Setint(ColumnNames.Id_listavehiculos, value);
			}
		}
		...
		public virtual string s_Id_listavehiculos
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Id_listavehiculos) ? string.Empty : base.GetintAsString(ColumnNames.Id_listavehiculos);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.Id_listavehiculos);
				else
					this.Id_listavehiculos = base.SetintAsString(ColumnNames.Id_listavehiculos, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter Id_listavehiculos
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.Id_listavehiculos, Parameters.Id_listavehiculos);
			...
			public WhereParameter Id_listavehiculos
		    {
				get
		        {
					if(_Id_listavehiculos_W == null)
	        	    {
						_Id_listavehiculos_W = TearOff.Id_listavehiculos;
					}
					return _Id_listavehiculos_W;
				}
			}
			...
			private WhereParameter _Id_listavehiculos_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter Id_listavehiculos
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.Id_listavehiculos, Parameters.Id_listavehiculos);
			...
			private AggregateParameter _Id_listavehiculos_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_usuario_lista_vehiculo_insert";
	
			CreateParameters(cmd);
			
			NpgsqlParameter p;
			p = cmd.Parameters[Parameters.Id_listavehiculos.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			NpgsqlCommand cmd = new NpgsqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_usuario_lista_vehiculo_update";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			NpgsqlCommand cmd = new NpgsqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = this.SchemaStoredProcedure + "rastreo_usuario_lista_vehiculo_delete";
	
			NpgsqlParameter p;
			p = cmd.Parameters.Add(Parameters.Id_listavehiculos);
			p.SourceColumn = ColumnNames.Id_listavehiculos;
